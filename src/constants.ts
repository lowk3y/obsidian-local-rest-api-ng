...
export const SECURITY_FILTER_DEFAULTS: {
...
export enum SecurityErrorCode {
  AccessDenied = 40300,
  WriteOperationDenied = 40301,
  MethodNotAllowed = 40302,
}
...
export const ERROR_CODE_MESSAGES: Record<ErrorCode, string> = {
  [ErrorCode.ApiKeyAuthorizationRequired]:
    "Authorization required.  Find your API Key in the 'Local REST API NG' section of your Obsidian settings.",
